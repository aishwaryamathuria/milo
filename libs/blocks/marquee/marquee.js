...
export default async function init(el) {
  ...
  el.querySelector('.action-area').innerHTML = `<label id="file-input-label" for="file-input">${inputSvg} Upload your photo</label><input type='file' class='upload-file' id="file-input" name="file-input" />`;
    ...
    fetchAndConvertToBase64(imageUrl, base64String => {
      ...
      if (!ccEverywhere) {
        ...
        ccEverywhere = await window.CCEverywhere.initialize({
          clientId: '9c87596521804dc1a52cd8508b585146',
          appName: 'ExpressEmbedDemoApplication',
          platformCategory: "web",
          redirectUri: "https://demo-stage.expressembed.com/"
        }, {
          loginMode: 'delayed',
          env,
        });
