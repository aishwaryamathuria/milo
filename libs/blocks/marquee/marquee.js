...
export default async function init(el) {
  ...
  el.querySelector('.action-area #file-input-label').className = el.querySelector('.foreground .asset.image #file-input-label').className + ' con-button blue button-xl button-justified-mobile';
